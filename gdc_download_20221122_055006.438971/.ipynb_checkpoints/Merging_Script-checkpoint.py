...
for files in os.scandir(dirname):
    ...
    update_file.to_csv(r'/Users/bigyambat/Desktop/TRGN_510/Adrenal_Cancer_Final_Project/gdc_download_20221122_055006.438971/CSV_Manifest.csv', index=False)
